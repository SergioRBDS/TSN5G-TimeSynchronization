...
Define_Module(GtpUserGnb);

using namespace omnetpp;
using namespace inet;

void GtpUserGnb::initialize(int stage)
{
    ...
    if (ownerType_ != PGW && ownerType_ != UPF)
    {
        ...
        bool connectedBS = isBaseStation(ownerType_);
...
NetworkInterface* GtpUserGnb::detectInterface()
{
...
CoreNodeType GtpUserGnb::selectOwnerType(const char * type)
{
...
void GtpUserGnb::handleMessage(cMessage *msg)
{
...
void GtpUserGnb::handleFromTrafficFlowFilter(Packet * datagram)
{
    /*
...
void GtpUserGnb::handleFromUdp(Packet * pkt)
{
    /*
